...
class AddRoomTypeModel
{
    ...
    {
        if (isset($_POST['name']) && isset($_POST['adults']) && isset($_POST['children']) && isset($_POST['Categories']) && isset($_POST['bed_type']) && isset($_POST['cost']) && isset($_POST['facilities']) && !empty($_POST['name']) && !empty($_POST['adults']) && !empty($_POST['children']) && !empty($_POST['Categories']) && !empty($_POST['bed_type']) && !empty($_POST['cost']) && !empty($_POST['facilities']) && isset($_FILES['image']['name']) && !empty($_FILES['image']['name'])) {
